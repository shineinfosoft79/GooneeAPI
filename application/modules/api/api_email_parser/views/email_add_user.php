...
<html>
    ...
    <body style="margin:0px; padding: 0px;">
        ...
        <table style="margin: 0px auto; padding:0px; border:1px solid #e4e4e4;" cellpadding:0; cellspacing:0; class="header" >
            ...
            <tr>
                <td style="font-size: 17px; color: #666; line-height: 22px; font-family: 'Roboto', sans-serif; padding: 10px 10px 10px 10px; ">
                    you are successfully register.
                </td>
            </tr>
            <tr>
                <td style="font-size: 17px; padding: 5px 0px 0px 10px; color: #000; font-weight: 700; font-family: 'Roboto', sans-serif;">
                    Welcome to erdos, We're glad you're here. 
                </td>
            </tr>
            <tr>
                <td style="font-size: 17px; color: #666; line-height: 22px; font-family: 'Roboto', sans-serif; padding: 5px 10px 10px 10px; ">
                    Email : {v_email}<br>
                    Password : {v_password}
                </td>
            </tr>
